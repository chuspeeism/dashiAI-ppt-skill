/**
 * AnthropicCasePage — P63 安全可靠模型 (Anthropic Case · Image-led · Case Card)
 *
...
const COPY = {
  eyebrow: 'Anthropic Case',
  title: '安全可靠模型',
  titleTail: 'Anthropic 案例页',
  logic: '安全模型逻辑',
  company: 'Anthropic',
  enName: 'ANTHROPIC',
  badge: '安全可靠',
  lead: 'Anthropic 的核心定位是安全、可靠与企业级模型能力；优势不是更激进的叙事，而是更可信的企业采用。',
  ...
  metrics: [
    { label: '累计融资', value: '650+', unit: '亿美元', num: true },
    { label: '公司估值', value: '9650', unit: '亿美元', num: true },
    { label: '核心产品', value: 'Claude', num: false },
    { label: '客户结构', value: '企业为主', num: false },
  ],
...
export const controls = [
  { key: 'eyebrow', label: '眉标', type: 'text', default: 'Anthropic Case' },
  { key: 'title', label: '标题', type: 'text', default: '安全可靠模型' },
  { key: 'titleTail', label: '副标题', type: 'text', default: 'Anthropic 案例页' },
  { key: 'logic', label: 'logic', type: 'text', default: '安全模型逻辑' },
  { key: 'company', label: 'company', type: 'text', default: 'Anthropic' },
  { key: 'enName', label: 'enName', type: 'text', default: 'ANTHROPIC' },
  { key: 'badge', label: 'badge', type: 'text', default: '安全可靠' },
  { key: 'lead', label: '导言', type: 'text', default: 'Anthropic 的核心定位是安全、可靠与企业级模型能力；优势不是更激进的叙事，而是更可信的企业采用。' },
  { key: 'closing', label: '结语', type: 'text', default: '可信度本身可以成为商业壁垒。' },
...
export default function AnthropicCasePage(props) {
