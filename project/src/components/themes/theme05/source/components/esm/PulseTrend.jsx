        ...
        {type !== "bar" && (
          <svg className="pulse-chart__svg" viewBox="0 0 100 100" preserveAspectRatio="none">
            {pts.map((p, i) => {
              ...
              return (
                <g key={i}>
                  <circle cx={xAt(i)} cy={yAt(p.v, max)} r={focus ? 2.4 : 1.7}
...
export default PulseTrend;
export const controls = PulseTrend.controls || [];
export const defaults = PulseTrend.defaults || {};
